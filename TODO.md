...
Is the `Node.depth` even needed? Could recompute on descent, removing padding as well.

## Bugs
- [ ] Bulk load doesn't test for duplicates

## Benchmarks
- **Minesweeper solver:** Queue of nodes to open
